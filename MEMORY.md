...
1. 🟠 **Giao hàng chưa có phí và chưa có giới hạn khoảng cách** (§11.12) - nông trại chở miễn phí đi bất cứ đâu. Ổn ở Ba Vì + Hà Nội, sai ngay khi có khách tỉnh khác.
2. 🟡 **Hoàn tiền chưa có gì tự nhắc** (§11.38) - cron không đụng bảng `Refund`, nên một khoản `REQUESTED` bị người trực để quên thì nằm im mãi. Người đang chờ tiền là người ít kiên nhẫn nhất.
...
> ⚠️ Mục 1 dưới đây **gấp hơn trước** kể từ Đợt 12. Việc `DELIVER` của chợ **chưa bao giờ mang theo địa chỉ** - `confirmMarketPaid` tạo việc với đúng câu *"giao tận tay rồi chụp ảnh"*, còn `HarvestLot.deliverTo` thì chỉ `claimLot` (nhận hàng của chính chủ) mới ghi. Trước đây điều đó **tạm sống được** vì người mua bắt buộc đang nuôi một chuồng, tức là khách quen của nông trại, hỏi một câu là ra. Nay người mua có thể là người **hoàn toàn xa lạ** (§11.40) - cô chú nhận việc giao mà không có một dòng nào nói giao đi đâu. Đây là mảnh còn thiếu rõ nhất sau đợt này.
