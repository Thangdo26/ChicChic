...
**Đợt tiếp theo, xếp theo giá trị** (chi tiết ở §4): **đường hoàn tiền** (§11.13 - lỗ duy nhất đang lệch về phía bất lợi cho NGƯỜI DÙNG) · hộp thư & thông báo (§11.6 §11.20) · siết an ninh và đối soát (§11.19 §11.21 §11.32 - CSP nằm ở đây) · test phủ cổng quyền (§11.18).
...
4. 🔴 **Chưa có đường HOÀN TIỀN** (§11.13) - **việc đáng làm nhất hiện nay.** Nguồn thu đã nối xong cả hai nửa (phí nghỉ hưu ✅ Đợt 6 · tiền nuôi ✅ Đợt 7), nhưng trả tiền tháng 3 rồi hôm sau hoàn trả chuồng thì tiền ở lại nông trại: không có nút trả lại theo tỉ lệ, cũng chưa có luồng huỷ giữa kỳ. Mọi lỗ khác trong repo đang lệch về phía nông trại; **đúng cái này lệch về phía khách**, nên nó lên đầu danh sách.
