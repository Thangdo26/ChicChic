...
1. 🟠 **Không có hàng rào tần suất ở BẤT KỲ đâu** (§11.19). Quét cả `src/`: không một chỗ nào giới hạn số lần gọi. Ba endpoint tiêu **tiền thật của nông trại**: `sendRegisterCode` + `sendResetCode` (mỗi lần là một email Resend, và ai cũng gọi được vì chưa đăng nhập là điều kiện tồn tại của chúng) và `traCuuChuTaiKhoan` (quota VietQR - đã bắt đăng nhập từ Đợt 11 nhưng một tài khoản vẫn bắn được không giới hạn). **Rẻ nhất trong danh sách này**, và là cái duy nhất người ngoài chủ động khai thác được.
2. 🟡 **QR đã thật nhưng chưa có bản in và chưa có đường thu hồi mã** (§11.15).
3. 🟡 **Đo lại đường cơ sở hiệu năng** (§11.23) - DB đã dời sang Singapore nhưng mọi con số trong tài liệu vẫn là số thời Mumbai, và §11.23 tự ghi rằng **đừng dùng số cũ để quyết chỗ nào đáng gọt**. Đo xong mới biết §11.31 có còn đáng quan tâm không.
4. 🟡 **§11.31** - 50/66 câu lệnh mỗi lần tải trang là chi phí bắt tay pgBouncer. **Đừng đụng trước khi đo lại theo mục 3.**

> ✅ **Đã xong ở Đợt 16:** hoàn tiền + chi trả nay có lời nhắc (§11.49) · đơn chợ mồ côi được dọn · người mua tự huỷ được đơn chưa trả tiền. Ba mục đầu của danh sách cũ đã hết.
