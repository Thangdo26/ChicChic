...
Đã làm xong: **① vòng nhắc ✅ → ② nhận hàng tận nhà ✅ → ③ lưới an toàn ✅ → ④ QR truy xuất thật ✅ → ⑤ sửa kho ảnh + video HEVC ✅ → ⑥ nối nguồn thu ✅ → ⑦ thu tiền nuôi + khoá chuồng ✅ → ⑧ trải nghiệm chờ ✅ → ⑨ chín mục chủ dự án nêu ✅ → ⑩ đường hoàn tiền + lứa mới hết miễn phí ✅**.
...
**Đợt tiếp theo, xếp theo giá trị** (chi tiết ở §4): **siết an ninh và đối soát** (§11.19 §11.21 §11.32 - CSP nằm ở đây) · hộp thư & thông báo (§11.6 §11.20) · test phủ cổng quyền (§11.18).
...
2. 🟠 **Test chưa phủ cổng quyền** (§11.18) - `npm test` phủ tầng logic, nhưng `canViewBarn` `threadAccess` `isAdmin` `requireWorker` và mọi phép ghi DB vẫn chỉ kiểm bằng tay. **Đợt 10 vừa cho thấy giá của khoảng trống này**: lỗ rò §11.37 nằm ngay trong `canViewBarn`/`barnViewer` và cả bốn lệnh kiểm đều xanh suốt thời gian nó tồn tại. (Bộ `hoan-tien` nay khoá được **một** dòng của cổng đó bằng cách đọc mã nguồn - mẹo rẻ tiền, không thay được việc dựng máy chủ trong test.)
3. 🟡 **Hoàn tiền chưa có gì tự nhắc** (§11.38) - cron không đụng bảng `Refund`, nên một khoản `REQUESTED` bị người trực để quên thì nằm im mãi. Người đang chờ tiền là người ít kiên nhẫn nhất.
4. 🟡 **QR đã thật nhưng chưa có bản in và chưa có đường thu hồi mã** (§11.15).
...
> Đã bịt trong ba đợt gần nhất, đừng làm lại: **chuồng hoàn trả bị công khai (§11.37)** · **đường hoàn tiền (§11.13, §11.38)** · **lứa mới miễn phí (§11.17)** · chọn nhận thịt không tạo việc (§11.10) · bàn giao chuồng (§11.9) · đàn `END_OF_LAY` im lặng · hoá đơn `REPORTED` bỏ quên không ai biết (§11.26) · lô hết hạn chỉ báo sau khi đã mất · **lô không bán được thì hết hạn rồi thôi** (§11.12).
