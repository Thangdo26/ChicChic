...
1. 🟡 **Hoàn tiền chưa có gì tự nhắc** (§11.38) - cron không đụng bảng `Refund`, nên một khoản `REQUESTED` bị người trực để quên thì nằm im mãi. Người đang chờ tiền là người ít kiên nhẫn nhất. **Rẻ nhất trong danh sách này**, khoảng một giờ.
2. 🟡 **Đơn chợ chưa có gì tự dọn** (§11.45) - giỏ tạo rồi bỏ nằm lại mãi, và đơn `RESERVED` quá 24 giờ thì lô tự nhả theo luật cũ nhưng hàng `MarketOrder` ở lại `RESERVED` vĩnh viễn. Người mua cũng **không tự huỷ được đơn đã chốt**, phải nhờ nông trại. Cùng họ với mục 1 - đều là việc cho `lib/jobs.ts`.
3. 🟡 **QR đã thật nhưng chưa có bản in và chưa có đường thu hồi mã** (§11.15).
4. 🟡 **§11.31** - 50/66 câu lệnh mỗi lần tải trang là chi phí bắt tay pgBouncer. **Đừng đụng trước khi deploy đúng vùng** - rất có thể lúc đó không còn đáng quan tâm.
