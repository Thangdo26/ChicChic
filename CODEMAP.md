...
37. **Dữ liệu của một đứa trẻ: một cửa vào, một cửa khoá, và không cửa nào đảo ngược.**
    ...
    Bốn luật, và cả bốn đều là loại hỏng-thì-không-sửa-lại-được. Neo bằng code: `tests/gia-dinh.test.ts` (56 phép).
